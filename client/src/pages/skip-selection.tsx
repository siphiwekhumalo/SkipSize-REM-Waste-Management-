...
export default function SkipSelection() {
  ...
  const [selectedSizeFilter, setSelectedSizeFilter] = useState<string | null>(
    null
  );
  ...
  const getSkipImages = (size: number) => {
    ...
    return (
      skipImageSets[size as keyof typeof skipImageSets] || [
        skipImage1,
        skipImage2,
        skipImage3,
      ]
  ...
  return (
    <div className="min-h-screen bg-black flex">
      ...
      <div
        className={`w-80 bg-gray-900/95 h-screen fixed top-0 backdrop-blur-sm border-r border-gray-700 z-50 transition-transform duration-300 ${
      ...
      >
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-800/60 rounded-lg p-6">
            <h2 className="text-xl font-bold text-white mb-4 hidden lg:block">
              Filter by Size
            </h2>
          ...
          {selectedSizeFilter && (
            <div className="mb-6 flex items-center justify-between">
              <div className="text-gray-300">
                ...
                skips found in{" "}
                <span className="text-orange-300">{selectedSizeFilter}</span>
              </div>
            </div>
          )}
          ...
          <div className="container max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:hidden space-y-3">
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  onClick={() =>
                    setLocation(`/permit-check?skipId=${selectedSkipId}`)
                  }
  ...
  return (
    <div
      className={`relative group transition-all duration-500 transform ${
        isSelected
          ? "scale-105 sm:rotate-1"
          : "hover:scale-102 sm:hover:-rotate-1"
      }`}
    >
      {/* Hexagonal/Angular Card Shape - Simplified for mobile */}
      <div
        className={`relative bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 overflow-hidden transition-all duration-300 ${
          isSelected
      ...
      >
        ...
        >
          ...
          <Skip360Viewer images={images} alt={skip.name} className="h-full" />
        ...
        <div className="relative p-6">
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-sm">{skip.dimensions}</p>
            </div>
